...
const REGION_HERO: Record<string, { title: string; kicker: string; image?: string }> = {
  delhi:     { title: 'Delhi',     kicker: 'Offline Sales Data', image: '/hero/delhi_lineart.svg1' },
  mumbai:    { title: 'Mumbai',    kicker: 'Offline Sales Data', image: '/hero/mumbai.svg1' },
  patna:     { title: 'Patna',     kicker: 'Offline Sales Data', image: '/hero/patna.svg1' },

...
export function facebookOverviewMock(range: string) {
    ...
    return {
        ...
        totalContent: 142,
        contentBreakdown: { posts: 96, reels: 22, stories: 24 },
        followersChange: 315,
        followersGained: 420,
        followersLost: 105,
        unsupported: ["reach", "following", "accountsEngaged"],
        from,
        to,
    };
}
...
export function facebookGrowthMock(range: string) {
    ...
    return {
        series: {
            ...
            views: { values: buildSeries(days, 16000, 3200, 60) },
            reach: { values: [] },
            pageViews: { values: buildSeries(days, 270, 60) },
            ...
            interactions: { values: buildSeries(days, 800, 260) },
            postsCount: { values: buildSeries(days, 5, 3) },
        },
    };
}
...
export function instagramOverviewMock(range: string) {
    ...
    return {
        ...
        totalContent: 208,
        contentBreakdown: { posts: 72, reels: 18, stories: 118 },
        followersChange: 540,
        followersGained: null,
        followersLost: null,
        unsupported: ["followersGained", "followersLost", "reactions"],
        from,
        to,
    };
}
...
export function instagramGrowthMock(range: string) {
    ...
    return {
        series: {
            ...
            views: { values: buildSeries(days, 21000, 4200, 90) },
            reach: { values: buildSeries(days, 11200, 2400, 40) },
            pageViews: { values: [] },
            followers: { values: buildSeries(days, 40800, 180, 18) },
            newFollowers: { values: [] },
            lostFollowers: { values: [] },
            netFollowers: { values: buildSeries(days, 51, 22) },
            interactions: { values: buildSeries(days, 4300, 1100) },
            postsCount: { values: buildSeries(days, 7, 4) },
        },
    };
}
...
export function youtubeOverviewMock(range: string) {
    ...
    return {
        ...
        interactions: null,
        accountsEngaged: null,
        contentBreakdown: { posts: null, reels: null, stories: null },
        unsupported: ["pageVisits", "reach", "following", "accountsEngaged"],
        from,
        to,
    };
}
...
export const metaAdsCampaignsMock = [
    {
        ...
        resultsLabel: "Leads",
        results: 1,
        funnel: { videoViews: 8200, engagement: 1450, linkClicks: 640, landingPageViews: 210, addToCart: 12, purchases: 4, leads: null, registrations: null, messagingStarted: 3, estimatedAdRecall: 5100 },
    },
    {
        id: "meta-ad-2",
